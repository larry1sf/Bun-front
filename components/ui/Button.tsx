...
export const Button = ({
    ...
    const baseStyles = 'px-3 py-2 md:px-6 md:py-4 rounded-2xl font-bold transition-all active:scale-[0.98] flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed text-sm md:text-base';
